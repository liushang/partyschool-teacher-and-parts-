<template>
  <div class="entry">
    ...
    <div class="entry-login">
      <div class="login-teacher" @click.stop="checkidentity('t')">教师登录</div>
      <div class="login-student" @click.stop="checkidentity('p')">部门登录</div>
    </div>
      ...
      <div class="model-part">
        <div class="part-scoll">
          <li v-for="(i,index) in schpart" class="part-li">
            ...
            <div @click.stop="checkpidentity(i.partshort,i.partname)">{{i.partname}}</div>
            <!--</router-link>-->
          </li>
        </div>
      </div>
