<template>
  <div class="attend">
    <div class="attend-class">
      <span v-if="this.$parent.pidentity==='pa'||this.$parent.pidentity==='pe'" class="class-name">
      ...
      <span v-else style="font-size: 12px">下一节:&nbsp;</span>
      <span class="class-name">
      <el-dropdown class="text-type" trigger="click" @command="handleCommand">
      <span class="el-dropdown-link class-name" style="font-size: 14px">{{classname}}<i class="el-icon-caret-bottom el-icon--right"></i>
      </span>
      ...
      <span class="class-num" v-if="this.$parent.pidentity!=='pa'">三</span>&nbsp;&nbsp;<span
