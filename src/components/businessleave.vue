  ...
  <div class="businessleave">
      ...
      <li v-for="(item, index) in leave">
        <el-col :span="24">
          <el-menu default-active="2" class="el-menu-vertical-demo" theme="">
            <el-submenu index="1" id="busylist">
              <template slot="title">
            ...
            <use xlink:href="#icon-cha2"></use>
              ...
              <el-menu-item index="1-6">申请人：{{item.person}}</el-menu-item>
              <el-menu-item index="1-7">申请部门：{{item.part}}</el-menu-item>
    ...
    <div class="mypuzzle" v-else>
      <li v-for="(item, index) in leave">
        <el-col :span="24">
          <el-menu default-active="2" class="el-menu-vertical-demo" theme="">
            <el-submenu index="1" id="ebusylist">
              <template slot="title">
                <span class="ltitle">{{item.time}} <svg @click.stop="deleteli(index)"
                                                        style="line-height: 56px" class="icon"
                                                        aria-hidden="true">
            <use xlink:href="#icon-cha2"></use>
              ...
              <el-menu-item index="1-6">申请人：{{item.person}}</el-menu-item>
              <el-menu-item index="1-7">所属部门：{{item.part}}</el-menu-item>
              <el-menu-item index="1-1">申请时间：{{item.ltime}}</el-menu-item>
              <el-menu-item index="1-2">申请总长：{{item.day}} 天</el-menu-item>
              <el-menu-item index="1-3">申请原因：{{item.reason}}</el-menu-item>
              <el-menu-item index="1-4">提交申请：{{item.time}}</el-menu-item>
    ...
    <div class="leavelist" v-if="!(this.$parent.identity==='p'&&this.$parent.pidentity==='pa')">
      ...
      <div class="leavelist-title"><span class="list-text">申请人</span><span class="text-text"><input class="day-num"
                                                                                                    v-model="listperson"
                                                                                                    type="text"></span>
        <div class="text-type"></div>
      </div>
      <div class="leavelist-title"><span class="list-text">所属部门</span><span class="text-text"><input class="day-num"
                                                                                                     v-model="listpart"
                                                                                                     type="text"></span>
        <div class="text-type"></div>
      </div>
  ...
  export default{
    ...
    methods: {
      ...
      stl(){
        ...
        } else if (this.$route.path === '/businessleave/tplace') {
          this.leave = this.tplace
        }
      },
      deleteli(obj){
    ...
    created(){
      ...
      this.leave = this.tbusiness
      console.log(this.state, this.pstate)
