...
import pgstuinfo from '@/components/pgstuinfo'
import stuinfo from '@/components/stuinfo'
import peschedule from '@/components/peschedule'
...
import edufile from '@/components/edufile'
...
const routes = [
  ...
  }, {path: '/', redirect: '/entry'}, {path: '/index', components: {default: index, h: header, b: routerbar}},
  {
    path: '/myfile',
    name: '公文批复',
    components: {default: myfile, h: header, b: routerbar},
    ...
    name: '部门信息',
    components: {default: partinfo}
  }, {
    path: '/person/partline',
    name: '在职人员',
    components: {default: partline}
  }, {
    path: '/pgstuinfo',
    name: '各班学员',
    components: {default: pgstuinfo}
  }, {
    path: '/edufile',
    name: '教学资料',
    components: {default: edufile, h: header}
  }, {
    path: '/classinfo',
    name: '班级信息',
    components: {default: classinfo},
    children: [{path: '/', redirect: 'stuinfo'}, {
      path: 'stuinfo',
      name: '班级信息',
      components: {default: stuinfo}
    }, {
      path: 'schedule',
      name: '班级信息',
      components: {default: peschedule}
    }, {
      path: 'change',
      name: '班级信息',
      components: {default: changeclass}
    }]
  }, {
    ...
    path: '/guide',
    name: '规章制度',
    components: {default: guide, h: header}
  }, {
    path: '/service',
    name: '服务指南',
    components: {default: service, h: header}
  }, {
    path: '/booknew',
    name: '图书上新',
    components: {default: booknew, h: header}
  }
]
